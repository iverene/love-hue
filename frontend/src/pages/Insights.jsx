...
import { Sparkles, Heart, Shield, ShieldAlert, MessageCircle, UserPlus, Sprout, ArrowRight, AlertCircle, HeartHandshake } from "lucide-react";
...
export default function Insights() {
  ...
  useEffect(() => {
    ...
    const generateInsights = async () => {
      ...
      try {
        const res = await axios.post(`${BASE_URL}/api/user/insights`, { answers });
        ...
        setError("We couldn't generate your palette right now. Please try again.");
      } finally {
        setLoading(false);
      }
    };
      ...
      <div className="min-h-screen bg-softWhite flex flex-col items-center justify-center relative overflow-hidden">
        ...
        <div className="z-10 text-center space-y-6 px-4">
          <div className="relative">
            ...
            <Heart className="w-16 h-16 text-coralPink animate-bounce mx-auto fill-coralPink/20" />
          </div>
          <h2 className="font-heading text-3xl text-charcoal">Analyzing your palette...</h2>
          ...
          <div className="max-w-5xl mx-auto space-y-12 animate-fade-in-up">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-white/60 border border-cloudGray p-6 rounded-2xl">
                ...
                <h4 className="font-heading text-xl font-bold text-charcoal mb-2">Your Strengths</h4>
                <p className="font-body text-sm text-mutedBlueGray leading-relaxed">{result.strengths}</p>
              </div>
              ...
              <div className="bg-white/60 border border-cloudGray p-6 rounded-2xl">
                ...
                <h4 className="font-heading text-xl font-bold text-charcoal mb-2">Challenges</h4>
                <p className="font-body text-sm text-mutedBlueGray leading-relaxed">{result.challenges}</p>
              </div>
              ...
              <div className="bg-white/60 border border-cloudGray p-6 rounded-2xl">
                ...
                <h4 className="font-heading text-xl font-bold text-charcoal mb-2">Communication</h4>
                <p className="font-body text-sm text-mutedBlueGray leading-relaxed">{result.communicationStyle}</p>
              </div>
              ...
              <div className="bg-white/60 border border-cloudGray p-6 rounded-2xl">
                ...
                <h4 className="font-heading text-xl font-bold text-charcoal mb-2">Ideal Match</h4>
                <p className="font-body text-sm text-mutedBlueGray leading-relaxed">{result.idealPartnerMatch}</p>
              </div>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-md border border-white rounded-3xl p-8 shadow-lg">
               <div className="flex items-center gap-3 mb-8">
                 ...
                 <h3 className="font-heading text-3xl text-charcoal">Path to Growth</h3>
               </div>
               
               <div className="grid md:grid-cols-2 gap-10">
                 <div>
                   <h4 className="font-body font-bold text-mutedBlueGray uppercase tracking-widest text-xs mb-3">For Yourself</h4>
                   <p className="font-body text-charcoal text-lg leading-relaxed border-l-4 border-coralPink pl-4">
                     {result.growthAdvice?.forSelf}
                   </p>
                 </div>
                 <div>
                   <h4 className="font-body font-bold text-mutedBlueGray uppercase tracking-widest text-xs mb-3">For Relationships</h4>
            ...
            <div className="max-w-3xl mx-auto mt-8">
              <div className="bg-softWhite/50 backdrop-blur-sm border border-white rounded-2xl p-8 text-center relative overflow-hidden">
                ...
                <h3 className="font-heading text-2xl md:text-3xl text-charcoal/90 italic mb-3 leading-snug">
                  "Everyone loves differently—and you just need to see their color as they are."
                </h3>
                
                <p className="font-body text-mutedBlueGray text-sm md:text-base max-w-lg mx-auto">
                  Just because someone's hue doesn't match yours, doesn't mean they love you any less. 
                  It simply means learning to appreciate a different kind of masterpiece.
                </p>
              </div>
            </div>
